...
import com.example.datn_project.databinding.ActivityLeaveDayStudentBinding;
...
public class LeaveDayStudentActivity extends AppCompatActivity {
    private ActivityLeaveDayStudentBinding mBinding;
    private int classId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = ActivityLeaveDayStudentBinding.inflate(getLayoutInflater());
    ...
    private void getData() {
        ...
        mBinding.rlt1.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), LeaveDayActivity.class);
        ...
        mBinding.rlt2.setOnClickListener(v -> {
            Intent intent = new Intent(this, LeaveDayActivity.class);
