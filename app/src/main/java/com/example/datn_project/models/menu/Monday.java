...
public class Monday implements Serializable {
    ...
    public Monday(Breakfast breakfast, MorningSupplement morning_supplement, Lunch lunch, Tea tea) {
    ...
    public Monday(Breakfast breakfast, MorningSupplement morning_supplement, Lunch lunch) {
        this.breakfast = breakfast;
        this.morning_supplement = morning_supplement;
        this.lunch = lunch;
    }
